...
if st.button("Prediksi Sentimen"):
    if user_input.strip() == "":
        ...
        tfidf_selected = tfidf_df[selected_features].to_numpy()

        # BWELM prediction
        bwelm_pred = bwelm_model.predict(tfidf_selected)[0]
        bwelm_proba = bwelm_model.predict_proba(tfidf_selected)[0]
